...
import {changeEnrollmentStatus, manageEnrollments } from "../../../services/enrollmentService";
...
export default function AlumniManageEnrollments() {
    ...
    const getEnrollments = () => {
        ...
        manageEnrollments(payload).then((res) => {
            if (res.data.success) {
                setLoading(false);
